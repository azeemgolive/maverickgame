    ...
    <a href="game-point-leader-board" class="tophd left">Point<br>leaderboard</a>
        ...
        <h3>Weekly Leaderboard</h3>
            ...
            if(isset($_SESSION['user_loged_id']))
            {
                ...
                $current_user=countWeeklyUserPointByUserId($_SESSION['user_loged_id']);
                if($current_user>0)
                {
        ...
        <div class="col-md-1 nopad-right">
          ...
          $user_rank=getWeelyPointsUserRank($_SESSION['user_loged_id']);
          echo $user_rank;
          ?></span></h4>
          </div>
          <div class="col-md-3">
         ...
         <tbody>
           ...
           $sore_games=getWeeklyPointLeaderBoard();
           if($sore_games>0)
            {
