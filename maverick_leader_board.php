...
<div class="container">
    ...
    <a href="game-point-leader-board" class="tophd">Point<br>leaderboard</a>
        ...
        <div class="bdr-bot-red" style="margin:0 0 5px;"></div>
         ...
         <table class="highscore_table table-nonfluid table table-striped allboards">
         <thead>
         <tr>
         <th>Rank</th>
         <th>Game</th>
         ...
         <?php
           $i=0;      
           $active="";
           $sore_games=getAllTimeLeaderBoard();
           if($sore_games>0)
            {
         ...
         <td><p><?php echo $score_game['game_name']; ?></p></td>
