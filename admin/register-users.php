                    ...
                    <table class="table no-margin">
                      ...
                      <tbody>
                         ...
                         ?>
                          ...
                          <td><div class="sparkbar" data-color="#00a65a" data-height="20"> <a href="edit-reward-store.php?id=<?php echo $user['id']; ?>">Edit</a> | <a href="delete-reward-store.php?id=<?php echo $user['id']; ?>" onclick='return confirmfunc()' >Delete</a></div></td> 
                        </tr>
                          <?php
                              }
                          }
