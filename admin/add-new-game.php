          ...
          <div class="row">
            ...
            <div class="col-md-8">
              ...
              <div class="box box-info">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form role="form" method="post" action="addnewgame.php" enctype="multipart/form-data" name="LoginForrm" id="LoginForrm">                                  
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="game_price" class="form-control" id="game_price" placeholder="Enter game price in coins">
                    </div>
                           
                    <div class="form-group">
                      <label for="exampleInputEmail1">Game Points Ratio</label>
                     <input type="text" name="game_points" class="form-control" id="game_points" placeholder="Enter point ratio">
                    </div>
                    
                    
                    <div class="form-group">
                      <label for="exampleInputEmail1">Game File Name</label>
                      <input type="text" name="game_filename" class="form-control" id="game_filename" placeholder="Enter File name">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="game_seo_title" class="form-control" id="game_seo_title" placeholder="Enter File name">
                    </div>
                    
                    
                    <div class="form-group">
                      <label for="exampleInputEmail1">Game Description</label>
                      <textarea class="form-control" rows="3" name="game_description" id="game_description"></textarea>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" rows="3" name="meta_tag_keywords" id="meta_tag_keywords"></textarea>
                    </div>
