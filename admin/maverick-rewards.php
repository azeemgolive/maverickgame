      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Maverick Rewards</li>
          </ol>
        </section>
                  ...
                  <div class="table-responsive">
                    <table class="table no-margin">
                      ...
                      <tbody>
                         ...
                         ?>
                          <tr>
                          <td><?php echo $topmenu['reward_id']; ?></td>
                          <td><?php echo $topmenu['reward_name']; ?></td>
                          <td><?php echo $topmenu['reward_points']; ?></td>                          
                          <td><div class="sparkbar" data-color="#00a65a" data-height="20"><?php echo date("j F, Y",strtotime($topmenu['createdAt'])); ?></div></td>
                          <td><div class="sparkbar" data-color="#00a65a" data-height="20"> <a href="edit-reward-store.php?id=<?php echo $topmenu['reward_id']; ?>">Edit</a> | <a href="delete-reward-store.php?id=<?php echo $topmenu['reward_id']; ?>" onclick='return confirmfunc()' >Delete</a></div></td>
                        </tr>
                          <?php
                              }
                          }
