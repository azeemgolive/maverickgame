      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">add new rewards</li>
          </ol>
        </section>
        <!-- Main content -->
          ...
          <div class="row">
            ...
            <div class="col-md-8">
              ...
              <div class="box box-info">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form role="form" method="post" action="addnewreward.php" enctype="multipart/form-data">                                  
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" rows="3" name="reward_description" id="product_description"></textarea>
                    </div>
