   ...
   <div class="row">
      <div class="col-md-8">
         ...
         <p class="white"> Points
           ...
           <tr>
             <td><?php echo date("d-m-y",  strtotime($user_redeem_point['utilize_points_date'])); ?></td>
                ...
                ?>
                 ...
                 <td>0</td>
                <td><?php echo $points_user['utilize_points']; ?></td>
              </tr>  
              <?php
                  }    
              }              
          ...
          <br/>
          <div class="col-md-6"><a href="purchase-coins" class="button large game right">PURCHASE COIN</a></div>
         <div class="col-md-6"> <a href="/maverick-game-rewards-store" class="button large game">REWARDS</a></div>
          </div>
          </div>
